...
def plot_schedule(schedule,lb = None,xmax = None, colors = None):
    ...
    if lb:
        ...
        ax.broken_barh([(lb-0.25,0.25)], (-0.5,n_workers+0.5), color = (1,1,1))
        ax.broken_barh([(lb,0.5)], (-0.5,n_workers+0.5), color = (1,0,0))
        ax.broken_barh([(lb+0.5,0.25)], (-0.5,n_workers+0.5), color = (1,1,1))
...
if __name__ == "__main__":
    ...
    with open("fixed_results.cpkl", "rb") as f:
